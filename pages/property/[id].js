...
const PropertyDetails = ({PropertyDetails : {price, rentFrequency, rooms, purpose, title, type, baths, area, agency, isVerified, description, furnishingStatus, amenities, photos}}) => (
